    ...
    <script>
        function loadWheel(svg, data, root) {
            ...
            async function showNestedTree(d) {
                ...
                const newData = getNestedTreeData(d)
             ...
             function getNestedTreeData(d) {
              let childrenData = []
              let childrens = []

              if (d.data.type === 'sub-odor') {
                 axios.get('/sub-odor/'+ d.data.page +'/odorants').then(response => {
              ...
              return  {
                "olfaction": {
                  ...
                  "page": d.parent.data.page,
                  "type": d.parent.data.type,
