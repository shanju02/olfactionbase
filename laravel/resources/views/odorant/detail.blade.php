      ...
      $( document ).ready(function() {
        ...
        function nodeClickHandler(event, d) {
          ...
          if (d.parent !== null) {
            ...
            if (d.data.type === 'subOdor') {
              redirectToUrl = "{{ route('index') }}" + "/odor?odor="+d.data.odor_id+"&subodor=" + d.data.id
            } else if (d.data.type === 'receptor') {
              redirectToUrl = "{{ route('index') }}" + "/receptor/"+d.data.id
            }
        ...
        createGraph({!! $odorsJson !!}, 'odorantGraph')
        createGraph({!! $receptorsJson !!}, 'receptorGraph')
