    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <h2 class="text-start" data-aos="fade-up" data-aos-delay="400" style="margin-bottom: 25px">A repository of Odors, Odorants, Olfactory Receptors and related information</h2>
