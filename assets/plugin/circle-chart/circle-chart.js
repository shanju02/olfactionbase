...
var Dial = function(container) {
    ...
    this.fill = this.container.dataset.fill;
...
Dial.prototype.setValue = function(value) {
    ...
    this.text.innerHTML = Math.floor(this.value) + '<tspan font-size="' + tspanSize + '" dy="' + -tspanSize * 1.2 + '"></tspan>';
};
...
let dial1 = new Dial(containers[0]);
let dial2 = new Dial(containers[1]);
let dial3 = new Dial(containers[2]);
let dial4 = new Dial(containers[3]);
let dial5 = new Dial(containers[4]);
let dial6 = new Dial(containers[5]);
let dial7 = new Dial(containers[6]);
let dial8 = new Dial(containers[7]);
let dial9 = new Dial(containers[8]);
let dial10 = new Dial(containers[9]);
let dial11 = new Dial(containers[10]);
let dial12 = new Dial(containers[11]);
let dial13 = new Dial(containers[12]);
let dial14 = new Dial(containers[13]);
let dial15 = new Dial(containers[14]);
let dial16 = new Dial(containers[15]);
let dial17 = new Dial(containers[16]);
